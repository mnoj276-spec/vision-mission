...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 2. Create core master States
        $statePanIndia = State::create(['name' => 'Pan India Central', 'code' => 'CENTRAL']);
        $stateUP = State::create(['name' => 'Uttar Pradesh', 'code' => 'UP']);
        $stateMaha = State::create(['name' => 'Maharashtra', 'code' => 'MH']);
        $stateDelhi = State::create(['name' => 'Delhi NCT', 'code' => 'DL']);
        $stateKar = State::create(['name' => 'Karnataka', 'code' => 'KA']);

        // 3. Create core Categories
        $catCivil = Category::create(['name' => 'UPSC & SSC Jobs', 'slug' => 'upsc-ssc-jobs']);
        $catBank = Category::create(['name' => 'Banking & Finance', 'slug' => 'banking-finance']);
        $catRail = Category::create(['name' => 'Railways (RRB)', 'slug' => 'railway-jobs']);
        $catDef = Category::create(['name' => 'Defense & Police', 'slug' => 'defense-jobs']);

        // 4. Create core Departments
        $deptUPSC = Department::create(['name' => 'Union Public Service Commission', 'code' => 'UPSC']);
        $deptSSC = Department::create(['name' => 'Staff Selection Commission', 'code' => 'SSC']);
        $deptRBI = Department::create(['name' => 'Reserve Bank of India', 'code' => 'RBI']);
        $deptSBI = Department::create(['name' => 'State Bank of India', 'code' => 'SBI']);
        $deptRRB = Department::create(['name' => 'Railway Recruitment Board', 'code' => 'RRB']);

        // 5. Create Qualifications
        $qTen = Qualification::create(['name' => '10th Pass (High School)', 'slug' => '10th-pass']);
        $qTwelve = Qualification::create(['name' => '12th Pass (Intermediate)', 'slug' => '12th-pass']);
        $qGrad = Qualification::create(['name' => 'Graduate Degree (Bachelor)', 'slug' => 'graduate']);
        $qPost = Qualification::create(['name' => 'Post Graduate Degree (Master)', 'slug' => 'post-graduate']);

        // 6. Create Automation Scraping Sources
        $srcUpsc = ScrapingSource::create([
        ...
        // 7. Seed Job posts representing realistic, high-quality entries
        JobPost::create([
