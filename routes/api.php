...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['throttle:api'])->group(function () {
        ...
        Route::get('/search/autocomplete', [\App\Http\Controllers\Api\V1\Search\SearchController::class, 'autocomplete'])
            ->middleware('throttle:30,1')
            ->name('api.v1.search.autocomplete');
        Route::get('/search/typo',         [\App\Http\Controllers\Api\V1\Search\SearchController::class, 'typoCorrection'])
            ->middleware('throttle:30,1')
            ->name('api.v1.search.typo');
